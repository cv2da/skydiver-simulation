...
class SysSimObject : public Trick::SimObject {
    ...
    public:
        ...
        SysSimObject() {
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "exec_collect_init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 2, "initialization", NULL, 1, "sched.write_s_run_summary", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 3, "initialization", NULL, 1, "sched.check_all_jobs_handled", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 4, "initialization", NULL, 1, "sched.check_all_job_cycle_times", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 5, "initialization", NULL, 1, "sched.create_threads", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 6, "initialization", NULL, 1, "sched.write_s_job_execution", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 7, "initialization", NULL, 1, "sched.async_freeze_to_exec_command", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 8, "checkpoint", NULL, 1, "sched.checkpoint", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 9, "post_checkpoint", NULL, 1, "sched.post_checkpoint", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 10, "restart", NULL, 1, "exec_collect_init", "", 60000) ;
            job->add_tag("TRK") ;
...
exec_register_scheduler(&mc) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "mc.process_sim_args", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "mc.execute_monte", "", 60000) ;
            job->add_tag("TRK") ;
...
exec_register_scheduler(&cpr) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "cpr.find_write_checkpoint_jobs", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "cpr.write_pre_init_checkpoint", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 2, "initialization", NULL, 1, "cpr.write_post_init_checkpoint", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 3, "system_checkpoint", NULL, 1, "cpr.write_checkpoint", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 4, "system_checkpoint", NULL, 1, "cpr.safestore_checkpoint", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 5, "shutdown", NULL, 1, "cpr.write_end_checkpoint", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 6, "freeze", NULL, 1, "cpr.load_checkpoint_job", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 7, "end_of_frame", NULL, 1, "cpr.load_checkpoint_job", "", 60000) ;
            job->add_tag("TRK") ;
        }
...
class SieSimObject : public Trick::SimObject {
    public:
        ...
        SieSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "sie.process_sim_args", "", 60000) ;
            job->add_tag("TRK") ;
...
class MessageSimObject : public Trick::SimObject {
    ...
    public:
        ...
        MessageSimObject() {
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 6, "initialization", NULL, 1, "mpublisher.init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 7, "initialization", NULL, 1, "mfile.init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 8, "initialization", NULL, 1, "pfile.init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 9, "initialization", NULL, 1, "mdevice.init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 10, "exec_time_tic_changed", NULL, 1, "mpublisher.init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 11, "restart", NULL, 1, "mdevice.restart", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 12, "restart", NULL, 1, "message_file_manager.restart", "", 60000) ;
            job->add_tag("TRK") ;
...
class JITSimObject : public Trick::SimObject {
    public:
        ...
        JITSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "input_processor", NULL, 1, "jit.process_sim_args", "", 60000) ;
            job = this->add_job(0, 1, "input_processor", NULL, 1, "jit.init", "", 60000) ;
        }
...
units_map_ptr = Trick::UnitsMap::units_map() ;
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 3, "shutdown", NULL, 1, "ip.shutdown", "", 60000) ;
            job->add_tag("TRK") ;
...
class ThreadProcessEventSimObject : public Trick::SimObject {
    public:
        ...
        ThreadProcessEventSimObject(unsigned int thread_id ) {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "initialization", NULL, 1, "ep.add_pending_events", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 1, "restart", NULL, 1, "ep.add_pending_events", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 2, "top_of_frame", NULL, 1, "ep.add_pending_events", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 3, "automatic", NULL, 1, "ep.process_event", "", 60000) ;
            job->add_tag("TRK") ;
...
em.add_event_processor(&ep) ;
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "ep.add_pending_events", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 2, "restart", NULL, 1, "ep.add_pending_events", "", 60000) ;
            job->add_tag("TRK") ;
...
class VariableServerSimObject : public Trick::SimObject {
    ...
    public:
        ...
        VariableServerSimObject() {
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "vs.init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 2, "monte_master_init", NULL, 1, "vs.init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 3, "initialization", NULL, 1, "monte_carlo_disable_all_apps", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 4, "initialization", NULL, 1, "Trick::launch_all_external_applications", "", 60000) ;
            job->add_tag("TRK") ;
...
exec_register_scheduler(&drd) ;
            job = this->add_job(0, 0, "initialization", NULL, 1, "drd.remove_files", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "drd.init", "", 60000) ;
            job->add_tag("TRK") ;
...
class RTSyncSimObject : public Trick::SimObject {
    ...
    public:
        ...
        RTSyncSimObject() : rt_sync(&gtod_clock, &itimer) {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "rt_sync.get_sim_start_time", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "rt_sync.rt_clock->calc_sim_time_ratio", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 2, "initialization", NULL, 1, "rt_sync.initialize", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 3, "initialization", NULL, 1, "rt_sync.start_realtime", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 4, "initialization", NULL, 1, "rt_sync.get_sim_end_init_time", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 5, "restart", NULL, 1, "rt_sync.restart", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 6, "freeze_init", NULL, 1, "rt_sync.freeze_init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 7, "freeze", NULL, 1, "rt_sync.freeze_pause", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 8, "unfreeze", NULL, 1, "rt_sync.unfreeze", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 9, "end_of_frame", NULL, 1, "rt_sync.rt_monitor", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 10, "shutdown", NULL, 1, "rt_sync.get_sim_end_time", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 11, "shutdown", NULL, 1, "rt_sync.shutdown", "", 60000) ;
            job->add_tag("TRK") ;
        }
...
class FrameLogSimObject : public Trick::SimObject {
    ...
    public:
        ...
        FrameLogSimObject(Trick::Clock &in_clock) : frame_log(in_clock) {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "instrumentation", NULL, 1, "frame_log.frame_clock_start", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 1, "instrumentation", NULL, 1, "frame_log.frame_clock_stop", "", 60000) ;
            job->add_tag("TRK") ;
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 5, "restart", NULL, 1, "frame_log.restart", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 6, "shutdown", NULL, 1, "frame_log.shutdown", "", 60000) ;
            job->add_tag("TRK") ;
        }
...
class MasterSlaveSimObject : public Trick::SimObject {
    ...
    public:
        ...
        MasterSlaveSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "initialization", NULL, 1, "master.process_sim_args", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "slave.process_sim_args", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 2, "initialization", NULL, 1, "master.init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 3, "initialization", NULL, 1, "slave.init", "", 60000) ;
            job->add_tag("TRK") ;
            ...
            job->add_tag("TRK") ;
            job = this->add_job(0, 6, "end_of_frame", NULL, 1, "master.end_of_frame_status_from_slave", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 7, "end_of_frame", NULL, 1, "master.end_of_frame_status_to_slave", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 8, "end_of_frame", NULL, 1, "slave.end_of_frame", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 9, "freeze_init", NULL, 1, "master.freeze_init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 10, "freeze_init", NULL, 1, "slave.freeze_init", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 11, "freeze", NULL, 1, "master.freeze", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 12, "freeze", NULL, 1, "slave.freeze", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 13, "unfreeze", NULL, 1, "master.unfreeze", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 14, "unfreeze", NULL, 1, "slave.unfreeze", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 15, "shutdown", NULL, 1, "master.shutdown", "", 60000) ;
            job->add_tag("TRK") ;
            job = this->add_job(0, 16, "shutdown", NULL, 1, "slave.shutdown", "", 60000) ;
            job->add_tag("TRK") ;
...
class InjectorExecSimObject : public Trick::SimObject {
    public:
        ...
        InjectorExecSimObject(unsigned int thread_id ) {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "top_of_frame", NULL, 1, "rtie.Exec", "", 60000) ;
            job->add_tag("TRK") ;
        }
...
class InjectorSimObject : public Trick::SimObject {
    ...
    public:
        ...
        InjectorSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "create_injector_executors", "", 60000) ;
            job->add_tag("TRK") ;
        }
...
class UnitTestSimObject : public Trick::SimObject {
    public:
        ...
        UnitTestSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "shutdown", NULL, 1, "unit_tests.write_output", "", 60000) ;
        }
...
class UdUnitsSimObject : public Trick::SimObject {
    public:
        ...
        UdUnitsSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "udunits.read_default_xml", "", 60000) ;
        }
...
class SkydiverSimObject : public Trick::SimObject {
    ...
    public:
        ...
        SkydiverSimObject() {
            Trick::JobData * job __attribute__((unused)) ;
            job = this->add_job(0, 0, "default_data", NULL, 1, "skydiver_default_data", "", 60000) ;
            job = this->add_job(0, 1, "initialization", NULL, 1, "skydiver_init", "", 60000) ;
            job = this->add_job(0, 2, "derivative", NULL, 1, "skydiver_update", "", 60000) ;
            job = this->add_job(0, 3, "integration", NULL, 1, "skydiver_integ", "", 60000) ;
            job = this->add_job(0, 4, "shutdown", NULL, 1, "skydiver_shutdown", "", 60000) ;
        }
